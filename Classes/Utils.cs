...
public class Utils
{
    ...
    public static void SetUINavigation(Selectable input, NavDirSet dirs)
    {
        Navigation nav = input.navigation;

        nav.selectOnUp = dirs.up;
        nav.selectOnRight = dirs.right;
        nav.selectOnDown = dirs.down;
        nav.selectOnLeft = dirs.left;
    ...
    public struct NavDirSet
    {
        public Selectable up, right, down, left;
    }
}
